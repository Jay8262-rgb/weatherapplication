function loadDelhi() {
    console.log('Delhi function working');
...
function loadJharkhand() {
    console.log('Jharkhand function working');
...
document.getElementById('refresh').addEventListener('click', loadDelhi);
document.getElementById('n-refresh').addEventListener('click', loadJharkhand);
